...
public class AppRepository {
    ...
    public enum App {
        ...
        APP_007(com.hulzenga.ioi_apps.app_007.WikipediaGameMenu.class, R.string.app_007_title,
        ...
        private App(Class activity, int title, int icon, int shortDescription, int longDescription) {
            this.title = title;
