...
/**
 * Not my code, see License.md. Naked copy inclusion is apparently the way this library is meant to
 * be used. TODO: check from time to time if NanoHTTPD has become available on Maven central
 */
